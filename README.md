...
37 款小游戏装进一个可离线运行的 Android App。当前开发版本 **1.2.0** 基于玩伴小屋游戏代码 **3.10.0**，保留单人游戏、人机挑战、7 套主题、本地进度和记录。
...
1. Android 8.0 及以上设备，从 Release 选择安装包：系统内核较新的设备用 `wanba-system-1.2.0.apk`；系统内核较旧、无法更新 WebView 的手机用 `wanba-compat-1.2.0.apk`（内置 GeckoView，支持 ARM 64/32 位）。
