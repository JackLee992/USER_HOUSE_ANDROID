// Executable module adaptation of the Screw game in the upstream fork baseline.
// The gameplay and canvas statements come from startScrew at c25b96a. Only bare
// host bindings are prefixed with env so the inline game can run as a package.
export const ORIGINAL_GAME_ID = 'screw';
export const FORK_BASELINE_COMMIT = 'c25b96a7c5aa74c5b37872bc5e1cd6a8c14e8226';
export const FORK_BASELINE_MANIFEST_VERSION = '3.7.0';
export const FORK_BASELINE_START_SCREW_SHA256 = '29dd56556451799a15eb890323a70934d7e250803964085e72b15cf2c1e2de66';
...
export function createForkBaselineGame(env, state) {
  startScrew(env, state);
